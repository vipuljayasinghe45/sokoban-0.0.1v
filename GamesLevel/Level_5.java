...
import Score.WriteAndRead_Level5;
 ...
 * @author Vipul
 */
public class Level_5 extends javax.swing.JFrame implements Runnable {
    ...
    public Level_5() {
        ...
        if (new WriteAndRead_Level5().readObject() == null) {
            jLabel2_Moves.setText("");
            maxtime = "00:00";
        } else {

            jLabel2_Moves.setText(WriteAndRead_Level5.txt.toString());
            maxtime = WriteAndRead_Level5.txt.toString();

        }
        int X = jLabel4.getLocation().x;
        int Y = jLabel4.getLocation().y;
    ...
    private void initComponents() {
        ...
        jButton1_tresure1.setBounds(130, 310, 70, 60);
        ...
        jButton2_tresure2.setBounds(310, 310, 70, 60);
        ...
        jButton3_tresure3.setBounds(460, 310, 70, 60);
        ...
        jButton_boy.setBounds(340, 220, 70, 60);
        ...
        jPanel1.add(jLabel4);
        jLabel4.setBounds(430, 640, 70, 60);
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(340, 640, 70, 60);
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(250, 640, 70, 60);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Maps/Level-5.jpg"))); // NOI18N
        jPanel1.add(jLabel1);
        jLabel1.setBounds(0, 0, 740, 810);
        ...
        getContentPane().add(jLabel2_Moves1, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 850, 80, 40));
        ...
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 850, 100, 40));
        ...
        getContentPane().add(jLabel2_Moves, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 850, 90, 40));
        ...
        getContentPane().add(jLabel4_Time, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 850, 70, 40));
        ...
        getContentPane().add(jLabel4_Time1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 850, 70, 40));

        jLabel8.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 51, 51));
        jLabel8.setText("   Moves");
        jLabel8.setPreferredSize(new java.awt.Dimension(59, 32));
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 850, 80, 40));

        jLabel9_y.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabel9_y.setText("  Y");
        getContentPane().add(jLabel9_y, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 810, 70, -1));

        jLabel8_x.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabel8_x.setText("   X");
        getContentPane().add(jLabel8_x, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 810, 70, -1));

        jLabel11.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabel11.setText("Tresure Location");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 810, 200, -1));

        jLabel5_Y.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabel5_Y.setText("  Y");
        getContentPane().add(jLabel5_Y, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 810, 80, -1));

        jLabel6_X.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabel6_X.setText("   X");
        getContentPane().add(jLabel6_X, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 810, 80, -1));

        jLabel10.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabel10.setText("Target Location");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 810, 190, -1));
    ...
    private void jButton_boyKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jButton_boyKeyPressed
        ...
        if (Tresure1_X == 250 && Tresure1_Y == 640) {
            tresure01(Tresure1_X, Tresure1_Y);
        }
        if (Tresure2_X == 340 && Tresure2_Y == 640) {
            tresure02(Tresure2_X, Tresure2_Y);
        }
        if (Tresure3_X == 430 && Tresure3_Y == 640) {
 ...
 // handling keys for moving playr and tresure
    ...
    private void goBoy(KeyEvent evt, int boy_x, int boy_y, int Tresure1_X,
            int Tresure2_X, int Tresure3_X, int Tresure1_Y, int Tresure2_Y,
            int Tresure3_Y) {
        this.boy_x = boy_x;
        this.boy_y = boy_y;
        ...
        switch (keys) {
            case KeyEvent.VK_UP:
                if ((boy_y == 80) || (boy_x == 200 && boy_y == 275)
                        || (boy_x == 205 && boy_y == 275)
                        || (boy_x <= 135 && boy_y == 210)
                        && (boy_x >= 70 && boy_y == 210)
                        || (boy_x == 70 && boy_y == 605)
                    ...
                    if (Tresure1_boy_X == 0 && Tresure1_boy_Y == -60) {
                        jLabel6_X.setText("" + 250);
                        jLabel5_Y.setText("" + 640);
                        if ((boy_y == 140) || (boy_x <= 135 && boy_y == 270)
                                && (boy_x >= 70 && boy_y == 270)
                                || (boy_x <= 210 && boy_y == 335)
                                && (boy_x >= 200 && boy_y == 335)
                                || (boy_x >= 535 && boy_y == 460)
            ...
            case KeyEvent.VK_DOWN:
                if ((boy_y == 670) || (boy_x == 400 && boy_y == 340)
                        || (boy_x == 395 && boy_y == 340)
                        || (boy_x == 210 && boy_y == 340)
                        || (boy_x == 205 && boy_y == 340)
                        || (boy_x == 65 && boy_y == 480)
                    ...
                    if (Tresure1_boy_X == 0 && Tresure1_boy_Y == 60) {
                        jLabel6_X.setText("" + 250);
                        jLabel5_Y.setText("" + 640);
                        if ((boy_y == 615) || (boy_x == 210 && boy_y >= 285)
                                && (boy_x == 210 && boy_y <= 290)
                                || (boy_x == 390 && boy_y == 280) && (boy_x == 400
                                && boy_y == 280) || (boy_x == 330
                                && boy_y == 420)
                                || (boy_x == 70) && boy_y == 420
                                || (boy_x >= 275 && boy_y == 420)
            ...
            case KeyEvent.VK_LEFT:
                if ((boy_x == 70) || (boy_x == 275 && boy_y <= 215)
                        && (boy_x == 275 && boy_y >= 80)
                        || (boy_x == 135 && boy_y >= 530)
                        && (boy_x == 135 && boy_y <= 540)
                        || (boy_x == 470 && boy_y >= 400)
                    ...
                    if (Tresure1_boy_X == -70 && Tresure1_boy_Y == 0) {
                        jLabel6_X.setText("" + 250);
                        jLabel5_Y.setText("" + 640);
                        if ((boy_x == 140) || (boy_x == 340 && boy_y <= 220)
                                && (boy_x == 340 && boy_y >= 80)
                                || (boy_x == 345 && boy_y >= 405)
                                && (boy_x == 345 && boy_y <= 480)
                                || (boy_x <= 205 && boy_y == 530)
            ...
            case KeyEvent.VK_RIGHT:
                if ((boy_x == 605) || (boy_x == 475 && boy_y <= 345)
                        && (boy_x == 475 && boy_y >= 80)
                        || (boy_x == 135 && boy_y == 210)
                        || (boy_x == 135 && boy_y >= 400)
                        && (boy_x == 135 && boy_y <= 550)
                    ...
                    if (Tresure1_boy_X == 70 && Tresure1_boy_Y == 0) {
                        jLabel6_X.setText("" + 250);
                        jLabel5_Y.setText("" + 640);
                        if ((boy_x == 535) || (boy_x == 405 && boy_y <= 345)
                                && (boy_x == 405 && boy_y >= 80)
                                || (boy_x == 255 && boy_y >= 400)
                                && (boy_x == 255 && boy_y <= 480)) {
...
// time
    ...
    private void BufferImage() {
        if (i == 3) {
            ...
            if (WriteAndRead_Level5.arrayList.isEmpty()) {
                MyText date1 = new MyText();
                date1.setText(maxtime);
                MyText date2 = new MyText();
                date2.setText(maxtime1);
                arrayList.add(date1);
                new WriteAndRead_Level5().writeObject(maxtime1, maxtime);
                ...
                date2.setText(maxtime1);
                arrayList.add(date1);
                new WriteAndRead_Level5().writeObject(maxtime, maxtime1);
            }
